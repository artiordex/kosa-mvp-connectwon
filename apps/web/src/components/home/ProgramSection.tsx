            ...
            <Link key={program['id']} href="/programs" className="group">
              <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group-hover:scale-[1.02]">
                <div className="relative">
                  ...
                  {program['category'] && (
                    <div className="absolute top-3 left-3">
                      <span className="px-2 py-1 bg-blue-600 text-white text-xs font-medium rounded-full">{program['category']}</span>
                    </div>
                  )}
                ...
                <div className="p-6">
                  ...
                  {/* 추가 정보가 있다면 표시 */}
                  {program['description'] && <p className="text-sm text-gray-600 mt-2 line-clamp-2">{program['description']}</p>}
                </div>
