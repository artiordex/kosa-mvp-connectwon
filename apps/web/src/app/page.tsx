...
export const metadata: Metadata = {
  title: 'ConnectWon',
  description: 'Reservation-based platform for challengers',
};
...
function Card({ title, desc, href }: { title: string; desc: string; href: string }) {
  return (
    <Link
      href={href}
      className="block rounded-2xl border border-gray-200 p-5 transition hover:shadow-sm"
    >
