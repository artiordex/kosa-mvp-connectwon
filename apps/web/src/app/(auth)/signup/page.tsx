          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-12 text-sm ${
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                  >
                    <i className={`${showConfirmPassword ? 'ri-eye-off-line' : 'ri-eye-line'} w-5 h-5`}></i>
                  </button>
                </div>
                ...
                <div>
                  <label className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <Link href="/terms" className="text-sm text-blue-600 hover:text-blue-800 ml-2">
                        [보기]
                      </Link>
                    </div>
                  </label>
                ...
                <div>
                  <label className="flex items-start">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <Link href="/privacy" className="text-sm text-blue-600 hover:text-blue-800 ml-2">
                        [보기]
                      </Link>
                    </div>
                  </label>
                  {errors['privacy'] && <p className="mt-1 text-sm text-red-600 ml-7">{errors['privacy']}</p>}
                </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 mt-6"
              >
                {loading ? '가입 중...' : '회원가입'}
              </button>
            </form>
