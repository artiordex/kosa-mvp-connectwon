      ...
      <div className={`flex flex-col items-center ${className}`}>
        ...
        {(showValue || showPercentage) && (
          <div className="mt-2 text-center">
            {showValue && <div className="text-lg font-bold text-gray-900">{value.toLocaleString()}{unit}</div>}
    ...
    <div className={`w-full ${className}`}>
      ...
      {(showValue || showPercentage) && (
        <div className="mt-1 flex items-center justify-end gap-2 text-right">
          {showValue && <div className="text-sm font-bold text-gray-900">{value.toLocaleString()}{unit}</div>}
